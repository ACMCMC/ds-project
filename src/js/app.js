App = {
  ...
  initContract: function() {
    $.getJSON('Crowdfund.json', function(crowdfund) {
      // Instantiate a new truffle contract from the artifact
      App.contracts.Crowdfund = TruffleContract(crowdfund);
      // Connect provider to interact with contract
      App.contracts.Crowdfund.setProvider(App.web3Provider);
  ...
  render: async function() {
    ...
    // Load contract data
    try {
      App.contract = await App.contracts.Crowdfund.deployed();
